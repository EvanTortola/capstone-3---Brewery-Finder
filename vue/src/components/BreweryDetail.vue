            ...
            <b-row>
                ...
                <b-col cols="8" >
                    ...
                    <div>
                        ...
                        <p class=" text-center mt-5 address city state zip phone hourOfOpp"> Located at {{ brewery.breweryAddress }} {{ brewery.breweryCity }}, {{ brewery.breweryState }} {{ brewery.zipCode }}  |  Phone Number: {{ brewery.phoneNumber}}</p>
